...
class MenuCard {
    constructor (src, alt, title, descr, price, parentSelection, ...classes) {
        this.src = src;
        this.alt = alt;
        this.title = title;
        this.descr = descr;
        ...
        this.parent = document.querySelector(parentSelection);
        this.transfer = 27;
        this.changeToUAH();
    }
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.default)('[data-modalOpen]', '.modal', modalTimerId);
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', "2020-10-21");
